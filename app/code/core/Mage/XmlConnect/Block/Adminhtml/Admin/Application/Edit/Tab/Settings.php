    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array('legend' => $this->__('Adminform Application Settings')));

        $fieldset->addField('type', 'select', array(
            'name'      => 'is_active',
            'label'     => $this->__('Enable Adminform Application'),
            'title'     => $this->__('Enable Adminform Application'),
